...
3. **Ghost**: Este estilo es rápido y de alto daño, con buena durabilidad. Es excelente en todo sentido, aunque sus jabs son un poco mas debiles a cambio de tener un jab instantánea el cual se usa con la tecla R, y tiene un cooldown corto.
4. **Shotgun**: Ademas de su muy rapida velocidad de golpes, inflige un gran daño y tiene una habilidad especial, la cual es su "Shotgun" con un cooldown semilargo la cual es una ráfaga de golpes que rompen facilmente la guardia del oponente y hace daño permanente como un M2. Es un buen counter a estilos con mucho daño y poca guardia si es usado correctamente.
5. **Freedom**: Este estilo combina movilidad y daño, haciendo que el jugador sea capaz de esquivar y atacar al mismo tiempo. Es versátil y eficaz contra diferentes tipos de oponentes. Pero con una clara debilidad, la cual es una vida mas pequeña
